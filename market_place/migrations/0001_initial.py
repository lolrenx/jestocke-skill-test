        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("ATTIC", "Attic"),
                            ("ROOM", "Room"),
                            ("HANGAR_WAREHOUSE", "Hangar / Warehouse"),
                ...
                (
                    "surface",
                    models.IntegerField(
                        blank=True, default=1, null=True, verbose_name="Surface (m²)"
                    ),
                ),
                (
                    "street_number",
                    models.CharField(
                        blank=True, max_length=128, null=True, verbose_name="N°"
                    ),
                ),
                (
                    "route",
                    models.CharField(
                        blank=True, max_length=512, null=True, verbose_name="route"
                    ),
                ),
                (
                    "additional_address",
                    models.TextField(
                        blank=True, null=True, verbose_name="additional address"
                    ),
                ),
                (
                    "postal_code",
